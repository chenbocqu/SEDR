...
for j = [1:9]
    ...
    handles.runTime = toc;
    guidata(hObject, handles);
    PlotEmbedding(hObject,eventdata,handles,j);
    end
end
...
for j = [1:9]
    ...
    if choose == 1
        %% OOPDR
        Y = oopdr( handles.X',handles.d,20,j );
        handles.Y = Y';
...
%% OOPDR
[yy,Ps] = SEDR_Process( handles.X',handles.d,15,handles.ColorVector);
X       = handles.X';
...
if n == 2
    if get(handles.ColorCheck,'Value') == 1 | handles.isExample == 1
        scatter(handles.X(:,1),handles.X(:,2),plotSize,handles.ColorVector,'filled');
    else
        scatter(handles.X(:,1),handles.X(:,2),plotSize,'filled');
    end;
    axis tight;
elseif n == 3
    if get(handles.ColorCheck,'Value') == 1 | handles.isExample == 1
        scatter3(handles.X(:,1),handles.X(:,2),handles.X(:,3),plotSize,handles.ColorVector,'filled');
    else
        scatter3(handles.X(:,1),handles.X(:,2),handles.X(:,3),plotSize,'filled');
    end;
    axis tight;
elseif n == 1
    if get(handles.ColorCheck,'Value') == 1 | handles.isExample == 1
        scatter(handles.X(:,1),ones(m,1),plotSize,handles.ColorVector,'filled');
    else
        scatter(handles.X(:,1),ones(m,1),plotSize,'filled');
    end;
    axis tight;
else
    cla;
...
if n == 2
    if get(handles.ColorCheck,'Value') == 1 | handles.isExample == 1
        scatter(handles.Y(:,1),handles.Y(:,2),plotSize,handles.ColorVector,'filled');
    else
        scatter(handles.Y(:,1),handles.Y(:,2),plotSize,'filled');
    end;
    axis tight;
elseif n == 3
    if get(handles.ColorCheck,'Value') == 1 | handles.isExample == 1
        scatter3(handles.Y(:,1),handles.Y(:,2),handles.Y(:,3),plotSize,handles.ColorVector,'filled');
    else
        scatter3(handles.Y(:,1),handles.Y(:,2),handles.Y(:,3),plotSize,'filled');
    end;
    axis tight;
elseif n == 1
    if get(handles.ColorCheck,'Value') == 1 | handles.isExample == 1
        scatter(handles.Y(:,1),ones(m,1),plotSize,handles.ColorVector,'filled');
    else
        scatter(handles.Y(:,1),ones(m,1),plotSize,'filled');
    end;
    axis tight;
else
    cla;
